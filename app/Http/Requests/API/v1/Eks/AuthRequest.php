            ...
            case 'post':
                if( $this->segment( 5 ) == 'register' ) {
                    ...
                    return [
                        ...
                        'couple_nik' => 'required_if:is_simple,0|required_if:status,2|numeric|digits:16',
                        'couple_name' => 'required_if:is_simple,0|required_if:status,2',
                        'couple_birth_place_id' => 'required_if:is_simple,0|required_if:status,2',
                        'couple_birth_date' => 'required_if:is_simple,0|required_if:status,2|date',
