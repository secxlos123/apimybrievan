...
class VisitReportRequest extends BaseRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'npwp'=> 'required_unless:use_reason,13|mimes:jpeg,png,jpg,zip,pdf',
            'salary_slip'=> 'required_if:source,fixed|mimes:jpeg,png,jpg,zip,pdf',
            'family_card'=> 'required_unless:use_reason,13|mimes:jpeg,png,jpg,zip,pdf',
            'offering_letter'=> 'required_unless:use_reason,13|mimes:jpeg,png,jpg,zip,pdf',
