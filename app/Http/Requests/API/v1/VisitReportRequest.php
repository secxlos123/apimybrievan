...
class VisitReportRequest extends BaseRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'mutations' => 'required_if:source,fixed|array',
            'mutations.*.bank' => 'required_if:source,fixed',
            'mutations.*.number' => 'required_if:source,fixed',
            'mutations.*.file' => 'required_if:source,fixed|file',
            'mutations.*.tables' => 'required_if:source,fixed|array',
            'mutations.*.tables.*.date' => 'required_if:source,fixed|date',
            'mutations.*.tables.*.amount' => 'required_if:source,fixed',
            'mutations.*.tables.*.type' => 'required_if:source,fixed',
