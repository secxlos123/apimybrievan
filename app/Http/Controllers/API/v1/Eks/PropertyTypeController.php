...
class PropertyTypeController extends Controller
{
    ...
    public function GetAllType()
    {
        ...
        $types = \DB::select(' select id,property_id,name from property_types where property_id in (select id from properties where developer_id != ? and is_approved = true)',[$developer_id]);
            return response()->success([
