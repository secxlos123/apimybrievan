        ...
        return response()->success( [
            ...
            'contents' => [
                'customer' => [
                    ...
                    'birth_place' => $customer->detail->birth_place_city->name,
                    ...
                    'address_status_name'=> $customer->detail->StatusAddress,
                    'mother_name' => $customer->detail->mother_name,
                    'email' => $customer->email,
                    'city_id'=> $customer->detail->city_id,
                    'city' => $customer->detail->city->name,
                    ...
                    'couple_identity'=> $customer->detail->CoupleIdentity,
