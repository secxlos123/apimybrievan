...
class EFormBriguna extends Authenticatable  
{
    ...
    {
        if( $this->BRIGUNA ) {
            return $this->BRIGUNA->request_amount;
        }
        return 0;
    }
    ...
    public function insertCoreBRI()
    {
        ...
        $request = [
            ...
            // "angsuran" => "500000",
            // "jenis_kpp_value" => "BRIGUNA Perorangan PNS / BUMN",
            ...
            // "uang_muka" => "51000000",
            "uang_muka" => $BRIGUNA->dp ? ( ( $BRIGUNA->request_amount * $BRIGUNA->dp ) / 100 ) : '',
            "jangka_waktu" => $BRIGUNA->year ? ( $BRIGUNA->year * 12 ) : '',
            ...
            "pihak_ketiga_value" => $BRIGUNA->developer_id  ? $BRIGUNA->developer_id : '',
