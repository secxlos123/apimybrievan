...
class Customer extends User
{
    ...
    {
		$IsFinish = DB::table('customer_details')->select("eforms.IsFinish")->where("user_id",$this->detail->user_id)where('id',(\DB::Raw("select max(id) from eforms where user_id='".$this->detail->user_id."'")))->get();
        $personal_data = [
