    ...
    public function insertPrescoringBriguna($data) {
        ...
        try {
            $content_las_prescoring = [
                "Fid_aplikasi"              => empty($data['Fid_aplikasi']) ? "123" : $data['Fid_aplikasi'],
                "Fid_cif_las"               => empty($data['Fid_cif_las']) ? "1234" : $data['Fid_cif_las'],
                ...
                "Maksimum_plafond"          => empty($data['Maksimum_plafond']) ? "1577479000" : $data['Maksimum_plafond'],
                ...
                "Plafond_usulan"            => "120000000",empty($data['Plafond_usulan']) ? "120000000" : $data['Plafond_usulan'],
                "Angsuran_usulan"           => empty($data['Angsuran_usulan']) ? "5648900" : $data['Angsuran_usulan'],
