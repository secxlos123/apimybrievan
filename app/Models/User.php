...
class User extends Authenticatable
{
    ...
    public function scopeGetCustomers( $query, Request $request )
    {
        ...
        return $query->leftJoin( 'customer_details', 'users.id', '=', 'customer_details.user_id' )->where( function( $user ) use( $request ) {
            ...
            'users.id', 'customer_details.nik', 'customer_details.city', 'customer_details.status', 'customer_details.mother_name', 'customer_details.couple_identity', 'customer_details.couple_nik', 'customer_details.couple_name', 'customer_details.couple_birth_date', 'customer_details.couple_birth_place', 'customer_details.identity'
        ], $userFill ) );
    }
